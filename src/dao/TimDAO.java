...
public class TimDAO {
	...
	public static Tim azurirajTim(Tim t) {
		try {
			em.getTransaction().begin();
			em.merge(t);
			em.getTransaction().commit();
	...
	public static void main(String[] args) {
		...
		/*
		 * for(Tim t:ispisiSveTimove()){ System.out.println(t.getNazivTima()); }
		 */
		/*
		 * Tim t = ispisiTim(1); izbrisiTim(t); for(Tim te:ispisiSveTimove()){
